...
[_QW] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,     KC_X,     KC_C,    KC_V,    KC_B,     KC_N,       KC_M,    KC_QUOT, KC_SLSH, MO(_NUM),  \
    KC_LCTL,  MO(_NUM), KC_COMMA, LCTL_T(KC_ENT),   KC_SPC,               KC_RGUI,  TG(_FUNC)),
...
[_FUNC] = LAYOUT(
    KC_TRNS,  RGB_MOD,  RGB_HUI,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_TRNS, \
