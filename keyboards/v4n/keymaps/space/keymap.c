...
/*!doc: Default */
  [_QW] = LAYOUT_SPACE( /* Qwerty */
    KC_1,    KC_2,     KC_3,    KC_F9,    KC_F10,    KC_F11, 
    ...
    KC_LCTL, MO(_NUM), KC_LALT, _______,  _______,  KC_SPC,            _______,  KC_RGUI, KC_ESC,  F_ENT
  ),
/*!end*/
//added sensible vim controls
/*!doc: Navigation*/
  [_NAV] = LAYOUT_SPACE( /* LAYER 1 */
...
/*!end*/
/*!doc: Numbers*/
  [_NUM] = LAYOUT_SPACE( /* LAYER 2 */
    KC_1,    KC_2,     KC_3,    KC_4,    KC_5,    KC_6, 
    KC_TILD,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5 ,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
    KC_ESC,    KC_PIPE, KC_DQUO, KC_UNDS, KC_PLUS, L_CURBR, R_CURBR, KC_4,    KC_5,    KC_6,    _______, KC_ENT,
    _______,   _______, _______, _______, _______, _______, KC_0,    KC_1,    KC_2,    KC_3,    _______, _______,
    _______,   _______, _______, _______,          _______, _______,           _______,  KC_VOLU, KC_VOLD, _______
  ),
/*!end*/
/*!doc: Functions*/
  [_FUNC] = LAYOUT_SPACE( /* LAYER 3 */
    KC_WAKE,    KC_2,     KC_3,    KC_4,    KC_5,    KC_6, 
    ...
    RESET, _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______,  _______,  KC_MPLY,  KC_VOLD,
