...
#define FUNCTION  TG(_FUNC)

// define curly brackets 
#define L_CURBR LSFT(KC_LBRC)
#define R_CURBR LSFT(KC_RBRC)

// escape that doubles as a lower
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, RAISE,   LOWER,   KC_LALT, KC_ENT,  KC_ENT,  KC_SPC,  KC_SPC,  KC_RGUI, LOWER,   RAISE,   FUNCTION
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, KC_PSCR, L_CURBR, R_CURBR, KC_LBRC, KC_RBRC, KC_HOME, KC_END,  KC_INSERT, KC_RSFT,    
...
[_FUNC] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, _______, _______,  KC_F1,   KC_F2,   KC_F3,   KC_F4, KC_BSPC,
    _______, _______, _______, _______, _______, _______, _______,  KC_F5,   KC_F6,   KC_F7,   KC_F8, KC_ENT,  
