...
/*!doc: Navigation*/
  [_NAV] = LAYOUT( /* LAYER 1 */
    ...
    KC_LCTL, KC_LGUI, _______, _______,           _______, _______,           _______,  _______, _______, _______
  ),
/*!end*/
/*!doc: Numbers*/
  [_NUM] = LAYOUT( /* LAYER 2 */
...
/*!doc: Functions*/
  [_FUNC] = LAYOUT( /* LAYER 3 */
    ...
    CG_NORM, KC_LSFT, _______, CG_SWAP,              KC_SPC,  _______,           _______,    _______, _______, _______
  )
/*!end*/
};
